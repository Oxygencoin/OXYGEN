...
RESOURCES += src/qt/oxygen.qrc src/qt/oxygen_locale.qrc

TRANSLATIONS += src/qt/locale/oxygen_bg.ts \
                src/qt/locale/oxygen_de.ts \
                src/qt/locale/oxygen_en.ts \
                src/qt/locale/oxygen_es.ts \
                src/qt/locale/oxygen_fi.ts \
                src/qt/locale/oxygen_fr.ts \
                src/qt/locale/oxygen_it.ts \
                src/qt/locale/oxygen_ja.ts \
                src/qt/locale/oxygen_pl.ts \
                src/qt/locale/oxygen_pt.ts \
                src/qt/locale/oxygen_ru.ts \
                src/qt/locale/oxygen_sk.ts \
                src/qt/locale/oxygen_sv.ts \
                src/qt/locale/oxygen_vi.ts \
                src/qt/locale/oxygen_zh_CN.ts \
                src/qt/locale/oxygen_zh_TW.ts

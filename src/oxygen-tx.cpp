...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OXYGEN Core oxygen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  oxygen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded oxygen transaction") + "\n" +
                               "  oxygen-tx [options] -create [commands]   " + _("Create hex-encoded oxygen transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded oxygen transaction

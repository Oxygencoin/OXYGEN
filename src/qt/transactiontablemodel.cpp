...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted OXYGEN to zOXYGEN");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zOXYGEN");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received OXYGEN from zOXYGEN");
    case TransactionRecord::ZerocoinSpend_Change_zOXYGEN:
        return tr("Minted Change as zOXYGEN from zOXYGEN Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zOXYGEN to OXYGEN");

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OXYGEN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OXYGEN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and oxygen: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOXYGEN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OXYGEN Core"), this);
    aboutAction->setStatusTip(tr("Show information about OXYGEN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OXYGEN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OXYGEN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OXYGEN addresses"));
    ...
    openAction->setStatusTip(tr("Open a OXYGEN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OXYGEN Core help message to get a list with possible OXYGEN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OXYGEN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OXYGEN network", "", count));
}
...
{
    QString strTitle = tr("OXYGEN Core"); // default title
...
/** Creates context menu, its actions, and oxygens up all the relevant signals for mouse events. */

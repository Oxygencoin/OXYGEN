...
public:
    ...
    void setZOXYGENControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzOXYGEN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzOXYGEN_clicked();
    void on_pushButtonZOXYGENControl_clicked();

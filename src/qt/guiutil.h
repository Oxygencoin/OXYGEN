...
/** Utility functions used by the OXYGEN Qt UI.
 */
namespace GUIUtil
{
...
// Render OXYGEN addresses in monospace font
...
// Parse "oxygen:" URI into recipient object, return true on successful parsing

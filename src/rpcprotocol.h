...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! OXYGEN is not connected
    ...
    RPC_WALLET_PASSOXYGENASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect

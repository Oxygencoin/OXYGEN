...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OXYGEN features */
        {"oxygen", "masternode", &masternode, true, true, false},
        {"oxygen", "listmasternodes", &listmasternodes, true, true, false},
        {"oxygen", "getmasternodecount", &getmasternodecount, true, true, false},
        {"oxygen", "masternodeconnect", &masternodeconnect, true, true, false},
        {"oxygen", "masternodecurrent", &masternodecurrent, true, true, false},
        {"oxygen", "masternodedebug", &masternodedebug, true, true, false},
        {"oxygen", "startmasternode", &startmasternode, true, true, false},
        {"oxygen", "createmasternodekey", &createmasternodekey, true, true, false},
        {"oxygen", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"oxygen", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"oxygen", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"oxygen", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"oxygen", "getmasternodescores", &getmasternodescores, true, true, false},
        {"oxygen", "mnbudget", &mnbudget, true, true, false},
        {"oxygen", "preparebudget", &preparebudget, true, true, false},
        {"oxygen", "submitbudget", &submitbudget, true, true, false},
        {"oxygen", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"oxygen", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"oxygen", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"oxygen", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"oxygen", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"oxygen", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"oxygen", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"oxygen", "checkbudgets", &checkbudgets, true, true, false},
        {"oxygen", "mnsync", &mnsync, true, true, false},
        {"oxygen", "spork", &spork, true, true, false},
        {"oxygen", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"oxygen", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use oxygend, or the -server option to oxygen-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> oxygen-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15460/\n";
}

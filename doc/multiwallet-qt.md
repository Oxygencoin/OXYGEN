...
In order to support loading of multiple wallets in oxygen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is oxygen.cpp.
...
Changes to oxygen.cpp
----------------------
oxygen.cpp is the entry point into oxygen-qt, and as such, will require some minor modifications to provide hooks for

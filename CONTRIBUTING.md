Contributing to OXYGEN Core
============================

The OXYGEN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OXYGEN Core project, and is not to be
confused with overall OXYGEN Network Protocol consensus changes.

Whether a pull request is merged into OXYGEN Core rests with the project merge
...
Patches that change OXYGEN consensus rules are considerably more involved than
...
Where a patch set proposes to change the OXYGEN consensus, it must have been
...
The project leader is the release manager for each OXYGEN Core release.
